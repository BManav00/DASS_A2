"""Core game-loop orchestration and turn resolution for MoneyPoly."""
...
class Game:
    ...
    def trade(self, seller, buyer, prop, cash_amount):
        ...
        if prop.owner != seller:
            ...
            return False
        if cash_amount <= 0:
            print("  Trade failed: cash amount must be greater than $0.")
            return False
    ...
    def _apply_card(self, player, card):
        ...
        handlers = {
            ...
            "birthday": self._handle_collect_from_all_card,
    ...
    def _handle_collect_from_all_card(self, player, value):
        """Apply actions where every other player pays the current player."""
